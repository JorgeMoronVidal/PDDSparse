function [PDDS_sol, Analytic_sol, error, G,G_sparsity, G_cond, B, B_estimated, Var_B, x, y, APL, Ctime, distances] = Import_PDDS(experiment)
    delimiterIn = ',';
    headerlinesIn = 1;
    ...
    sol_route = append(experiment, '/solution.csv');
